...
wb = load_workbook('C:\\Users\\Dell\\Desktop\\TY\\Python\\Bill-Generator-master\\excel.xlsx') 

sheet = wb.active 

def excel():
	sheet.cell(row=1, column=1).value = "Mob: 9422380760"
...
def insert(): 
	if (date.get() == "" and
		...
		# save the file 
		wb.save('C:\\Users\\Dell\\Desktop\\TY\\Python\\Bill-Generator-master\\excel.xlsx') 
...
if __name__ == "__main__": 
	...
	heading = Label(root, text="Pooja Computer's", bg="light green")
